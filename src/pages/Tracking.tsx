...
const Tracking = () => {
  ...
  const buildSteps = (order: OrderRow) => {
    ...
    // Correspondance avec les boutons de l'AdminDashboard
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="container px-4 py-12 mx-auto max-w-4xl">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-black text-gray-900 mb-4">Suivi de votre Colis</h1>
          <p className="text-gray-500 font-medium">Entrez votre numéro de commande pour voir l'avancement en temps réel.</p>
        </div>
          ...
          <Card className="border-none shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-6 duration-500 rounded-[2.5rem]">
            <CardHeader className="bg-green-900 text-white py-8 px-10">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle className="text-2xl font-black">Commande {trackingData.id}</CardTitle>
                    ...
                    <div key={index} className="relative flex items-start ml-10">
                      <div
                        className={
                          ...
                          (isDone ? "bg-green-600 scale-110" : isActive ? "bg-orange-500 animate-pulse" : "bg-stone-200")
                        }
                      >
                        {isDone && (
                      ...
                      >
                        <div className="flex justify-between items-center mb-2">
                          ...
                          {isDone && <Badge className="bg-green-600 text-white text-[10px] font-black">TERMINÉ</Badge>}
                        </div>
                        <p className={"text-sm font-medium " + (isDone ? "text-green-700" : isActive ? "text-orange-700" : "text-gray-400")}
                        >
                          {step.description}
                        </p>
                      </div>
