...
const AdminDashboard = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // On récupère les courses sans jointure pour éviter l'erreur de relation
      ...
      <div className="container px-4 py-12 mx-auto">
        ...
        <Tabs defaultValue="orders" className="w-full">
          <TabsList className="mb-8 bg-white p-1 rounded-xl shadow-sm border">
            <TabsTrigger value="orders" className="font-bold">Commandes ({orders.length})</TabsTrigger>
            <TabsTrigger value="rides" className="font-bold">Courses Thiak-Thiak ({rides.length})</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="rides">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {rides.map((ride) => (
                <Card key={ride.id} className="border-none shadow-md rounded-3xl overflow-hidden bg-white">
